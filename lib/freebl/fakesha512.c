...
// Counts the invocations of this hash functions
...
#endif
//	memset(ctx->md_data,'\0', SHA_DIGEST_LENGTH + 1);
}
...
{
    size_t i;
    *digestLen = PR_MIN(SHA256_LENGTH, maxDigestLen);
    memcpy(digest, H, *digestLen);
#ifndef __CPROVER__
